...
<div class="form-group col-sm-6" id="especificar_enfermedad" style="display: none;">
...
<div class="form-group col-sm-6" id="especifique_defecto_fisico" style="display: none;">
...
const especificar_enfermedad = document.querySelector("#especificar_enfermedad");
const presenta_defecto_fisico = document.querySelector("#presenta_defecto_fisico");
const especifique_defecto_fisico = document.querySelector("#especifique_defecto_fisico");

padece_enfermedad.addEventListener("change", () => {
  if (padece_enfermedad.value === "Si") {
    especificar_enfermedad.style.display = 'initial';
  } else {
    especificar_enfermedad.style.display = 'none';
  }
});

presenta_defecto_fisico.addEventListener("change", () => {
  if (presenta_defecto_fisico.value === "Si") {
    especifique_defecto_fisico.style.display = 'initial';
  } else {
    especifique_defecto_fisico.style.display = 'none';
  }
});
</script>
<!-- Estado Civil Field -->
...
<div class="form-group col-sm-6" id="plan_sin_deducible" style="display: none;">
  
</div>
<div class="form-group col-sm-6" id="plan_con_deducible" style="display: none;">
...
<div class="form-group col-sm-6">
    {!! Form::label('ci_beneficiario', 'Cedula de identidad de beneficiario:') !!}
